...
module QueryExamples = 
    ...
    let queryByHashKey () = 
        ...
        assertThat (response.Count = 10) 
                   (sprintf "Response has incorrect Count : %d %d" response.Count 10)
        assertThat (response.Items.Count = 10)
                   (sprintf "Response has incorrect Items count : %d %d" response.Items.Count 10)
        assertThat (response.Items |> Seq.forall (fun attrs -> attrs.["Id"].N = "250"))
                   "Id should all be 250"

        (* ---------------- query using DynamoDBContext ---------------- *)
        printfn "(DynamoDBContext) Running basic hash key query :\n\t\t%s" selectQuery
        let replies  = cxt.ExecQuery<Reply>(selectQuery) |> Seq.toArray
        ...
        assertThat (countResponse.Count = 10)
                   (sprintf "Count response has incorrect Count : %d %d" countResponse.Count 10)
    ...
    let queryByHashAndRangeKey () =
        ...
        let response = client.Query(selectQuery)
        assertThat (response.Count = 2) 
                   (sprintf "Response has incorrect Count : %d %d" response.Count 2)
        assertThat (response.Items.Count = 2)
                   (sprintf "Response has incorrect Items count : %d %d" response.Items.Count 2)
        assertThat (response.Items |> Seq.forall (fun attrs -> attrs.["Id"].N = "250"))
                   "Id should all be 250"
        assertThat (response.Items |> Seq.forall (fun attrs -> attrs.["ReplyDateTime"].S >= twoDaysAgoStr))
        ...
        let countResponse = client.Query(countQuery)
        assertThat (countResponse.Count = 2)
                   (sprintf "Count response has incorrect Count : %d %d" countResponse.Count 2)
    ...
    let queryWithOrderByAndLimit () =
        ...
        let response = client.Query(selectQuery)
        assertThat (response.Count = 3) 
                   (sprintf "Response has incorrect Count : %d %d" response.Count 3)
        assertThat (response.Items.Count = 3)
                   (sprintf "Response has incorrect Items count : %d %d" response.Items.Count 3)
        assertThat (response.Items |> Seq.forall (fun attrs -> attrs.["Id"].N = "250"))
                   "Id should all be 250"
        assertThat (response.Items |> Seq.forall (fun attrs -> attrs.["ReplyDateTime"].S <= sevenDaysAgoStr))
        ...
        assertThat (response.Items |> Seq.forall (fun attrs -> attrs.["Id"].N = "250"))
                   "Id should all be 250"
        assertThat (response.Items |> Seq.forall (fun attrs -> attrs.["ReplyDateTime"].S >= threeDaysAgoStr))
    ...
    let selectSpecificAttributes () =
        ...
        assertThat (response.Items |> Seq.forall (fun attrs -> attrs.["Id"].N = "250"))
                   "Id should all be 250"
        assertThat (response.Items |> Seq.forall (fun attrs -> attrs.Count = 2 && attrs.ContainsKey "Id" && attrs.ContainsKey "Message"))
    ...
    let queryWithIndexAllAttributes () =
        ...
        assertThat (response.Items |> Seq.forall (fun attrs -> attrs.["Id"].N = "250"))
                   "Id should all be 250"
        assertThat (response.Items |> Seq.forall (fun attrs -> attrs.["PostedBy"].S.StartsWith "J"))
                   "PostedBy should all start with \"J\""
        assertThat (response.Items |> Seq.forall (fun attrs -> attrs.Count = 4 && attrs.ContainsKey "Message"))
    ...
    let queryWithIndexProjectedAttributes () =
        ...
        assertThat (response.Items |> Seq.forall (fun attrs -> attrs.["PostedBy"].S.StartsWith "J"))
                   "PostedBy should all start with \"J\""
        assertThat (response.Items |> Seq.forall (fun attrs -> attrs.Count = 3 && (not <| attrs.ContainsKey "Message")))
...
module ScanExamples =
    ...
    let basicScan () =
        ...
        printfn "Found %d results" response.Count
        ...
        let replies  = cxt.ExecScan<Reply>(selectQuery) |> Seq.toArray
        printfn "Found %d results" response.Count
